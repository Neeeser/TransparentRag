...
describe("model-sorting", () => {
  it("keeps default chat model order", () => {
    const models: ModelInfo[] = [
      { id: "a", name: "Alpha", supported_parameters: [] },
      { id: "b", name: "Beta", supported_parameters: [] },
    ];
  ...
  it("treats non-numeric pricing values as missing", () => {
    const models: ModelInfo[] = [
      { id: "a", name: "Alpha", pricing: { prompt: "abc" }, supported_parameters: [] },
      { id: "b", name: "Beta", pricing: { prompt: "0.01" }, supported_parameters: [] },
    ];
    const sorted = sortChatModels(models, "price");
  ...
  it("returns missing prices when no digits are present", () => {
    const models: ModelInfo[] = [
      { id: "a", name: "Alpha", pricing: { prompt: "$$" }, supported_parameters: [] },
      { id: "b", name: "Beta", pricing: { prompt: "$0.1" }, supported_parameters: [] },
    ];
    const sorted = sortChatModels(models, "price");
    expect(sorted.map((model) => model.name)).toEqual(["Beta", "Alpha"]);
  });
  ...
  it("treats non-finite numeric strings as missing", () => {
    const models: ModelInfo[] = [
      { id: "a", name: "Alpha", pricing: { prompt: "1e309" }, supported_parameters: [] },
      { id: "b", name: "Beta", pricing: { prompt: "0.01" }, supported_parameters: [] },
    ];
    const sorted = sortChatModels(models, "price");
    expect(sorted.map((model) => model.name)).toEqual(["Beta", "Alpha"]);
  ...
  it("sorts embedding models by price", () => {
    const models: EmbeddingModelInfo[] = [
      { id: "a", name: "Alpha", pricing: { prompt: "0.5" } },
      { id: "b", name: "Beta", pricing: { completion: 0.1 } },
      { id: "c", name: "Gamma", pricing: null },
      { id: "d", name: "Delta", pricing: { prompt: 0.1 } },
    ];
  ...
  it("sorts embedding models by dimension", () => {
    const models: EmbeddingModelInfo[] = [
      { id: "a", name: "Alpha", dimension: 1024 },
      { id: "b", name: "Beta", dimension: null },
      { id: "c", name: "Gamma", dimension: 512 },
      { id: "d", name: "Delta", dimension: 512 },
    ];
  ...
  it("returns a copy when sorting embedding models", () => {
    const models: EmbeddingModelInfo[] = [{ id: "a", name: "Alpha" }];
    const sorted = sortEmbeddingModels(models, "price");
  ...
  it("returns a copy for unsupported embedding sort options", () => {
    const models: EmbeddingModelInfo[] = [
      { id: "a", name: "Alpha", pricing: { prompt: 0.1 } },
      { id: "b", name: "Beta", pricing: { prompt: 0.2 } },
    ];
